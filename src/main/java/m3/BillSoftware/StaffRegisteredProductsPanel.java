...
public class StaffRegisteredProductsPanel extends JPanel {
    ...
    private class ImageCellRenderer extends JLabel implements TableCellRenderer {
        ...
        public ImageCellRenderer() {
            ...
            setBorder(new LineBorder(Color.LIGHT_GRAY)); // Add border to image cells
        }
    ...
    private void createUI() {
        ...
        // Set custom renderer for numeric columns with borders
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, 
                ...
                setBorder(new LineBorder(Color.LIGHT_GRAY)); // Add border to all cells
